$(document).ready(function() {
    ...
    for(const key in Time.months)if (Time.months.hasOwnProperty(key)) {
        const element = Time.months[key];
        if (element != Time.currentTime.month) $(".main-content .month").append("<span>" + element + Time.monthUnit + "</span>");
    }
    for(const key in Time.days)if (Time.days.hasOwnProperty(key)) {
        const element = Time.days[key];
        if (element != Time.currentTime.day) $(".main-content .day").append("<span>" + element + Time.dayUnit + "</span>");
    }
    for(const key in Time.weeks)if (Time.weeks.hasOwnProperty(key)) {
        const element = Time.weeks[key];
        if (element != Time.currentTime.week) $(".main-content .week").append("<span>" + element + "</span>");
    }
    for(const key in Time.shichens)if (Time.shichens.hasOwnProperty(key)) {
        const element = Time.shichens[key];
        if (element != Time.currentTime.shichen.str) $(".main-content .shichen").append("<span>" + element + "</span>");
    }
    for(const key in Time.hours)if (Time.hours.hasOwnProperty(key)) {
        const element = Time.hours[key];
        if (element != Time.currentTime.hour) $(".main-content .hour").append("<span>" + element + Time.hourUnit + "</span>");
    }
    for(const key in Time.minutes)if (Time.minutes.hasOwnProperty(key)) {
        const element = Time.minutes[key];
        if (element != Time.currentTime.minute) $(".main-content .minute").append("<span>" + element + Time.minuteUnit + "</span>");
    }
    for(const key in Time.seconds)if (Time.seconds.hasOwnProperty(key)) {
        const element = Time.seconds[key];
        if (element != Time.currentTime.second) $(".main-content .second").append("<span>" + element + Time.secondUnit + "</span>");
    }
    setTimeout(function() {
        $(".month span").each(function(index, element) {
            ...
            style.insertRule("@keyframes month" + index + "{0%{transform: rotateZ(0);transform-origin: -" + monthLeft + " " + top + ";}100%{transform:rotateZ(" + -30 * index + "deg);transform-origin: -" + monthLeft + " " + top + ";}}", style.rules.length);
        });
    }, 0);
    setTimeout(function() {
    ...
    function run() {
        ...
        if (next.text() == "") next = $(".second span").first();
        ...
        if ((secText == "0秒" || secText == "零秒" || secText == "0 s") && (minText == "0分" || minText == "零分" || minText == "0 m")) {
            ...
            if (next.text() == "") next = $(".hour span").first();
        ...
        if ((secText == "0秒" || secText == "零秒" || secText == "0 s") && (minText == "0分" || minText == "零分" || minText == "0 m") && isShichen(hourText)) {
            ...
            if (next.text() == "") next = $(".shichen span").first();
        ...
        if ((secText == "0秒" || secText == "零秒" || secText == "0 s") && (minText == "0分" || minText == "零分" || minText == "0 m") && (hourText == "0时" || hourText == "零时" || hourText == "0 h")) {
            ...
            if (nextweek.text() == "") nextweek = $(".week span").first();
            ...
            dayi++;
            if (dayi > Time.days.length) dayi = 1;
        }
        //进月
        ...
        if ((dayText == "1 day" || dayText == numToSimp(1) + "日" || dayText == numToTrad(1) + "日" || dayText == "1日") && (secText == "0秒" || secText == "零秒" || secText == "0 s") && (minText == "0分" || minText == "零分" || minText == "0 m") && (hourText == "0时" || hourText == "零时" || hourText == "0 h")) {
            ...
            if (next.text() == "") next = $(".month span").first();
...
//# sourceMappingURL=index.ecafa84a.js.map
